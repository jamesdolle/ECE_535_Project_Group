...
def get_dataset(args):
    ...
    if args.dataset == 'cifar10':
        ...
        transform_train = transforms.Compose([
            transforms.ColorJitter(0,0.6,0.4), ## Brig: 0, Contrast: 0.6
            transforms.ToTensor(),
            transforms.Normalize((0.4914),(0.4914)),
        ])
    ...
    # print(type(train_data_distribution),type(train_dataset))
    # print(type(test_data_distribution),type(test_dataset))
